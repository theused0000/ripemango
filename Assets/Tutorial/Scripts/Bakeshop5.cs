...
public class Bakeshop5 : MonoBehaviour {

	public string[] dialogs;
	public string[] names;
	
	public Bakeshop5(string[] sName, string[] sDialog, string namePlayer) {
		sName = new string[9];
		...
		sName[2] = namePlayer;
		sDialog [2] = "I can’t believe it myself. It has been that long, and now you can open your third bakeshop!";
		
		sName[3] = "Felicia";
		sDialog[3] = "Teehee, it’s all thanks to you. Actually, I received a message from my father saying...";
		
		sName[4] = "Felicia";
		sDialog [4] = "that he found another place in Francia that I can use if ever... You know, if I decided to expand my bakeshop.";
		...
		sName[8] = "System";
		sDialog[8] = "Congratulations for completing your bakeshop! You have earned $14,000 cash bonus which you can use for purchasing the new branch.";
